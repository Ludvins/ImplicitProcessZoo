...
class TestMFVIConstruction:
    ...
    def test_invalid_likelihood(self, bnn_variational):
        with pytest.raises(ValueError):
            MFVI(bnn_variational, OUTPUT_DIM, "poisson", NUM_DATA, device=DEVICE, dtype=DTYPE)
...
class TestMFVIShapes:
    ...
    def model(self, bnn_variational):
        return MFVI(bnn_variational, OUTPUT_DIM, "regression", NUM_DATA, device=DEVICE, dtype=DTYPE)
